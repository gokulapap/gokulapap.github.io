      ...
      >
        <nav className="mx-auto flex max-w-7xl items-center justify-between px-5 md:px-8 py-4 md:py-5">
          <a href="#top" className="group flex items-center gap-3">
            {/* Gradient G mark — simple, bold, with inner ring + hover glow */}
            <span className="relative grid place-items-center h-10 w-10 rounded-xl overflow-hidden transition-all duration-300 group-hover:shadow-[0_0_28px_rgba(16,185,129,0.45)] group-hover:scale-[1.05]">
              <span
                aria-hidden
                className="absolute inset-0 bg-gradient-to-br from-accent-emerald via-accent-cyan to-accent-violet"
              />
              {/* subtle top-edge highlight for a slight glassy feel */}
              <span
                aria-hidden
              ...
              />
              <span className="relative font-display font-bold text-lg text-ink-950 tracking-tight">
                G
              </span>
            </span>
